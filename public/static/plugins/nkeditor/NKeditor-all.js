...
_plugin('core', function(K) {
	...
	self.clickToolbar('about', function() {
		var html = '<div style="margin:20px;">' +
			...
			'<div>Forked from KindEditor By BlackFox. <a href="http://git.oschina.net/blackfox/kindeditor">Gité¡¹ç›®åœ°å€</a>.</div>' +
			'</div>';
		self.createDialog({
			name : 'about',
			width : 350,
...
KindEditor.lang({
	...
	editMedia : 'è§†éŸ³é¢‘å±žæ€§',
	deleteMedia : 'åˆ é™¤è§†éŸ³é¢‘',
	editLink : 'è¶…çº§é“¾æŽ¥å±žæ€§',
	deleteLink : 'å–æ¶ˆè¶…çº§é“¾æŽ¥',
	editAnchor : 'é”šç‚¹å±žæ€§',
	deleteAnchor : 'åˆ é™¤é”šç‚¹',
	tableprop : 'è¡¨æ ¼å±žæ€§',
	tablecellprop : 'å•å…ƒæ ¼å±žæ€§',
	tableinsert : 'æ’å…¥è¡¨æ ¼',
	...
	invalidRows : 'è¡Œæ•°ä¸ºå¿…é€‰é¡¹ï¼Œåªå…è®¸è¾“å…¥å¤§äºŽ0çš„æ•°å­—ã€‚',
	invalidCols : 'åˆ—æ•°ä¸ºå¿…é€‰é¡¹ï¼Œåªå…è®¸è¾“å…¥å¤§äºŽ0çš„æ•°å­—ã€‚',
	...
	'image.imgTitle' : 'å›¾ç‰‡è¯´æ˜Ž',
	'image.upload' : 'æµè§ˆ...',
	'image.viewServer' : 'å›¾ç‰‡ç©ºé—´',
	'multiimage.title' : 'å¤šå›¾ä¸Šä¼ ',
	'multiimage.uploadDesc' : 'å…±é€‰æ‹©äº† <%=numSelect%> å¼ å›¾ç‰‡ï¼Œå…± <%=totalSize%>, è¿˜å¯ä»¥æ·»åŠ  <%=numLeft%> å¼ å›¾ç‰‡.',
	'multiimage.startUpload' : 'å¼€å§‹ä¸Šä¼ ',
	'multiimage.noListUrl' : 'æ— æ³•èŽ·å–å›¾ç‰‡ï¼Œè¯·å…ˆé…ç½® fileManagerJson.',
	'multiimage.noSearchUrl' : 'æ— æ³•è¿›è¡Œå›¾ç‰‡æœç´¢ï¼Œè¯·å…ˆé…ç½® imageSearchJson.',
	'multiimage.noDataText' : '(âŠ™oâŠ™)äº²ï¼Œæ²¡æœ‰å¤šæ•°æ®äº†ã€‚',
	'multiimage.closeText' : 'å…³é—­å¯¹è¯æ¡†',
	'multiimage.confirmBtnText' : 'ç¡®å®š',
	'multiimage.cancelBtnText' : 'å–æ¶ˆ',
	'multiimage.loadMoreData' : 'å¾€ä¸‹æ‹‰åŠ¨æ»šåŠ¨æ¡å¯ä»¥åŠ è½½æ›´å¤šæ•°æ®.',
	'multiimage.depJQueryError' : 'æ–‡ä»¶ç®¡ç†æ’ä»¶ä¾èµ– jQuery, è¯·å…ˆå¼•å…¥ jQuery.',
	'multiimage.localUpload' : 'æœ¬åœ°ä¸Šä¼ ',
	'multiimage.fileServer' : 'æ–‡ä»¶æœåŠ¡å™¨',
	'multiimage.imgSearch' : 'å›¾ç‰‡æœç´¢',
	'multiimage.selectFile' : 'ç‚¹å‡»é€‰æ‹©å›¾ç‰‡',
	'multiimage.continueAdd' : 'ç»§ç»­æ·»åŠ ',
	'multiimage.searchBtn' : 'æœç´¢ä¸€ä¸‹',
	'multiimage.searchPlaceholder' : 'è¯·è¾“å…¥æœç´¢å…³é”®è¯',
	'multiimage.searchClear' : 'æ¸…ç©ºæœç´¢',
	'multiimage.noFileAdded' : 'è¯·è‡³å°‘æ·»åŠ ä¸€ä¸ªæ–‡ä»¶ï¼',
	'multiimage.uploading' : 'æ­£åœ¨ä¸Šä¼ ',
	'multiimage.fileNotUpload' : 'æ‚¨è¿˜æœ‰æ–‡ä»¶æ²¡æœ‰ä¸Šä¼ !',
	'multiimage.uploadLimit' : 'æ‚¨æœ¬æ¬¡æœ€å¤šä¸Šä¼  <%=uploadLimit%> ä¸ªæ–‡ä»¶.',
	'multiimage.sizeLimit' : 'æ–‡ä»¶å¤§å°ä¸èƒ½è¶…è¿‡ <%=sizeLimit%> KB.',
	'multiimage.invalidExt' : 'éžæ³•çš„æ–‡ä»¶åŽç¼€ <%=invalidExt%>.',
	'multiimage.remove' : 'åˆ é™¤',
	'multiimage.rotateRight' : 'å‘å³æ—‹è½¬',
	'multiimage.rotateLeft' : 'å‘å·¦æ—‹è½¬',
	'multiimage.uploadFail' : 'å‘ç”Ÿå¼‚å¸¸ï¼Œä¸Šä¼ å¤±è´¥!',
	'multiimage.noFileSelected' : 'è¯·è‡³å°‘é€‰æ‹©ä¸€ä¸ªæ–‡ä»¶æˆ–ä¸€å¼ å›¾ç‰‡.',
	'filemanager.noDataText' : '(âŠ™oâŠ™)äº²ï¼Œæ²¡æœ‰å¤šæ•°æ®äº†ã€‚',
	'filemanager.title' : 'æ–‡ä»¶æœåŠ¡å™¨',
	'filemanager.noListUrl' : 'æ— æ³•èŽ·å–å›¾ç‰‡ï¼Œè¯·å…ˆé…ç½® fileManagerJson.',
	'filemanager.closeText' : 'å…³é—­å¯¹è¯æ¡†',
	'filemanager.confirmBtnText' : 'ç¡®å®š',
	'filemanager.cancelBtnText' : 'å–æ¶ˆ',
	'filemanager.loadMoreData' : 'å¾€ä¸‹æ‹‰åŠ¨æ»šåŠ¨æ¡å¯ä»¥åŠ è½½æ›´å¤šæ•°æ®.',
	'filemanager.depJQueryError' : 'æ–‡ä»¶ç®¡ç†æ’ä»¶ä¾èµ– jQuery, è¯·å…ˆå¼•å…¥ jQuery.',
	'filemanager.fileType' : 'ç±»åž‹',
	'graft.btnText' : 'ä¿å­˜å¹¶æ’å…¥æ¶‚é¸¦',
	'graft.uploadSuccess' : 'æ¶‚é¸¦ä¸Šä¼ æˆåŠŸ',
	'graft.uploadFaild' : 'æ¶‚é¸¦ä¸Šä¼ å¤±è´¥',
	'graft.empty' : 'æ‚¨æ²¡æœ‰åœ¨ç”»å¸ƒä¸Šç»˜åˆ¶ä»»ä½•å›¾åƒ',
	'insertfile.url' : 'URL',
	'insertfile.title' : 'æ–‡ä»¶è¯´æ˜Ž',
	...
	self.plugin.anchor = {
		edit : function() {
			var html = ['<div class="ke-dialog-content-inner">',
					...
					'<label for="keName">' + lang.name + 'ï¼š</label>',
...
/*
* å¦‚ä½•å®žçŽ°çœŸæ­£çš„è‡ªåŠ¨é«˜åº¦ï¼Ÿ
* ä¿®æ”¹ç¼–è¾‘å™¨é«˜åº¦ä¹‹åŽï¼Œå†æ¬¡èŽ·å–bodyå†…å®¹é«˜åº¦æ—¶ï¼Œæœ€å°å€¼åªä¼šæ˜¯å½“å‰iframeçš„è®¾ç½®é«˜åº¦ï¼Œè¿™æ ·å°±å¯¼è‡´é«˜åº¦åªå¢žä¸å‡ã€‚
* æ‰€ä»¥æ¯æ¬¡èŽ·å–bodyå†…å®¹é«˜åº¦ä¹‹å‰ï¼Œå…ˆå°†iframeçš„é«˜åº¦é‡ç½®ä¸ºæœ€å°é«˜åº¦ï¼Œè¿™æ ·å°±èƒ½èŽ·å–bodyçš„å®žé™…é«˜åº¦ã€‚
* ç”±æ­¤å°±å®žçŽ°äº†çœŸæ­£çš„è‡ªåŠ¨é«˜åº¦
	...
	self.plugin.flash = {
		edit : function() {
			var html = [
				...
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="keUrl" class="row-left">' + lang.url + 'ï¼š</label>',
				'<div class="row-right">',
				...
				'</div>',
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="keWidth" class="row-left">' + lang.width + 'ï¼š</label>',
				'<div class="row-right">',
				'<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="550" maxlength="4" /> ',
				'</div>',
				'</div>',
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="keHeight" class="row-left">' + lang.height + 'ï¼š</label>',
				'<div class="row-right">',
...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<div class="ke-dialog-row ke-clearfix">',
			'<label for="remoteUrl" class="row-left">' + lang.remoteUrl + 'ï¼š</label>',
			'<div class="row-right">',
			...
			'</div>',
			'<div class="ke-dialog-row ke-clearfix ">',
			'<label for="remoteWidth" class="row-left">' + lang.size + 'ï¼š</label>',
			...
			'</div>',
			'<div class="ke-dialog-row ke-clearfix">',
			'<label class="row-left">' + lang.align + 'ï¼š</label>',
			'<div class="row-right">',
			...
			'</div>',
			'<div class="ke-dialog-row ke-clearfix">',
			'<label for="remoteTitle" class="row-left">' + lang.imgTitle + 'ï¼š</label>',
			'<div class="row-right">',
			...
			'<div class="ke-dialog-row ke-clearfix">',
			hiddenElements.join(''),
			'<label class="row-left">' + lang.localUrl + 'ï¼š</label>',
			'<div class="row-right">',
...
KindEditor.plugin('insertfile', function(K) {
	...
	self.plugin.fileDialog = function(options) {
		...
		var html = [
			...
			'</div>',
			'<div class="ke-dialog-row ke-clearfix">',
			'<label for="keTitle" class="row-left">' + lang.title + 'ï¼š</label>',
			'<div class="row-right">',
	...
	self.plugin.link = {
		edit : function() {
			var lang = self.lang(name + '.'),
				...
				'</div>',
				'<div class="ke-dialog-row ke-clearfix"">',
				'<label for="keType" class="row-left">' + lang.linkType + 'ï¼š</label>',
				'<div class="row-right">',
	...
	self.plugin.media = {
		edit : function() {
			var html = [
				...
				'</div>',
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="keAutostart" class="row-left">' + lang.autostart + 'ï¼š</label>',
				'<div class="row-right">',
...
KindEditor.plugin('graft', function(K) {
	...
	self.plugin.graftDialog = function(options) {
		...
		var html = [
			...
			'<canvas id="canvas-borad" class="brushBorad">ä½ çš„æµè§ˆå™¨ä¸æ”¯æŒ canvas ç»˜å›¾</canvas>',
			'<div class="picBoard" id="picBoard" style=""></div>',
			'</div>',
			'<div class="operateBar">',
			'<button id="J_prevStep" class="prevStep" title="ä¸Šä¸€æ­¥">',
			'<em class="icon"></em>',
			'</button>',
			'<button id="J_nextStep" class="nextStep" title="ä¸‹ä¸€æ­¥">',
			'<em class="icon"></em>',
			'</button>',
			'<button id="J_clearBoard" class="clearBoard" title="æ¸…ç©º">',
			'<em class="icon"></em>',
			'</button>',
			'</div>',
			'</div>',
			...
			'<em class="icon"></em>',
			'<em class="text">åˆå§‹åŒ–è®¾ç½®</em>',
			'</span>',
			'</div>',
			'<div class="sectionBar">',
			'<div id="J_addImg" class="addImgH">',
			'<em class="icon"></em>',
			'<em class="text">æ·»åŠ èƒŒæ™¯</em>',
	...
	self.plugin.table = {
		prop : function(isInsert) {
			var html = [
				'<div class="ke-dialog-content-inner">',
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="keRows" class="row-left">' + lang.cells + 'ï¼š</label>',
				'<div class="row-right">',
				...
				'</div>',
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="keWidth" class="row-left">' + lang.size + 'ï¼š</label>',
				'<div class="row-right">',
				...
				'</div>',
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="kePadding" class="row-left">' + lang.space + 'ï¼š</label>',
				'<div class="row-right">',
				...
				'</div>',
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="keAlign" class="row-left">' + lang.align + 'ï¼š</label>',
				'<div class="row-right">',
				...
				'</div>',
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="keBorder" class="row-left">' + lang.border + 'ï¼š</label>',
				'<div class="row-right">',
				...
				'</div>',
				'<div class="ke-dialog-row ke-clearfix">',
				'<label for="keBgColor" class="row-left">' + lang.backgroundColor + 'ï¼š</label>',
				'<div class="row-right">',
